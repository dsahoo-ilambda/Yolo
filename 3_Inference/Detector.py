...
image_test_folder = os.path.join(TINY_YOLO_ROOT, 'test_images')

detection_results_folder = os.path.join(TINY_YOLO_ROOT, 'inference')
detection_results_file = 'Detection_Results.csv'

model_folder = os.path.join(TINY_YOLO_ROOT, 'models')

model_weights = os.path.join(model_folder, 'trained_weights_final.h5')
model_classes = os.path.join(TINY_YOLO_ROOT, 'category_names.txt')
...
if __name__ == '__main__':
    ...
    if input_image_paths:
        ...
        df_path = os.path.join(output_path, FLAGS.box)
        out_df.to_csv(df_path, index=False)
        print(f"The Detection csv saved to : {df_path}")
